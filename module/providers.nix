...
# (NixOS module system 自动合并, 用户值优先级高于 default)
{
  ...
  tuna = {
    ...
    goproxy = {url = "https://mirrors.tuna.tsinghua.edu.cn/goproxy";};
  };
  ...
  ustc = {
    ...
    rustup = {url = "https://mirrors.ustc.edu.cn/rustup";};
    goproxy = {url = "https://mirrors.ustc.edu.cn/goproxy";};
  };
  ...
  tencent = {
    ...
    goproxy = {url = "https://mirrors.cloud.tencent.com/goproxy";};
  };
  ...
  bfsu = {
    ...
    rustup = {url = "https://mirrors.bfsu.edu.cn/rustup";};
    goproxy = {url = "https://mirrors.bfsu.edu.cn/goproxy";};
  };
  ...
  sjtu = {
    ...
    goproxy = {url = "https://mirror.sjtu.edu.cn/goproxy";};
  };
